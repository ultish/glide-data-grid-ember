...
| 4 | Core cell types + overlay editors | 4a done, browser-verified, committed (text/number/boolean/loading/protected/row-id + overlay editor framework). 4b/4c/4d pending |
