...
| 9 | Backlog — deferred features (**not auto-scheduled**; 15 grouped items 9a–9o, see detail below) | Not scheduled. **The live backlog is now `TODO.md`, which supersedes the 9a–9o lists below for anything still open.** Landed since: many 9-items, Phase 10, queue items 1–6, and TODO.md §4.2 `@getGroupDetails` (2026-08-12, browser-verified — see PORTING-NOTES.md) |
