...
| 3 | Interaction layer (selection, copy/paste, sort menu, DnD resize/reorder, hover anim) | **In progress** — 3a (selection+clicks), 3b (keyboard nav), 3c (copy/paste) done+committed; 3d (resize/reorder DnD) pending |
