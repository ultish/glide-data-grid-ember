...
import { BooleanIndeterminate, BooleanEmpty } from '../data-grid-types.js';
import { roundedRect } from './data-grid-lib.js';

function drawCheckbox(ctx, theme, checked, x, y, width, height, highlighted, hoverX = -20, hoverY = -20, maxSize = undefined, alignment = "center", style = "square") {
