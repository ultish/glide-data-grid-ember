...
function isStarCell(cell) {
  return cell.data.kind === "star-cell";
}
...
function pathStar(ctx, centerX, centerY, size) {
  let moved = false;
 ...
 */
function starRatingForPosX(posX, cellHorizontalPadding) {
...
const starCellRenderer = {
  ...
  draw: (args, cell) => {
    ...
    const starX = i => rect.x + padX + STAR_START_OFFSET + i * STAR_SPACING;
...
export { starCellRenderer, starRatingForPosX };
//# sourceMappingURL=star-cell.js.map
