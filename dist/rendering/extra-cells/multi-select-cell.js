...
import { getLuminance } from '../color-parser.js';
...
const multiSelectCellRenderer = {
  ...
  measure: (ctx, cell, theme) => {
    ...
    const bubblesWidth = labels.reduce((acc, label) => ctx.measureText(label).width + acc + theme.bubblePadding * 2 + theme.bubbleMargin, 0);
...
// port).
function buildMultiSelectEditor(p) {
...
export { multiSelectCellRenderer };
//# sourceMappingURL=multi-select-cell.js.map
