 ...
 * that subtree.
 */
function resolveCssColor(element, expression) {
 ...
 */
function themeFromCss(element, mapping) {
  const out = {};
 ...
 */
function themeOverlaysEqual(a, b) {
...
export { CssThemeWatcher, resolveCssColor, themeFromCss, themeOverlaysEqual };
