...
const NO_SCROLL_EDGE = [0, 0];
function scrollEdgesAreEqual(a, b) {
  if (a === b) return true;
 ...
 */
function computeScrollEdge(x, y, width, height, totalHeaderHeight) {
 ...
 */
function adjustDragLocationForScroll(location, edge, visible, visibleColStart, maxCol, maxRow) {
...
export { Autoscroller, NO_SCROLL_EDGE, adjustDragLocationForScroll, computeScrollEdge, scrollEdgesAreEqual };
