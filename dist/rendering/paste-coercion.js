import { isEditableGridCell, GridCellKind, BooleanIndeterminate, BooleanEmpty } from './data-grid-types.js';
...
function pasteBufferToString(buf) {
  return Array.isArray(buf.rawValue) ? buf.rawValue.join(", ") : buf.rawValue?.toString() ?? buf.formatted.toString();
}
 ...
 */
function coercePasteCell(existing, buf, getCellRenderer, coercePasteValue) {
    ...
    case GridCellKind.Boolean:
      {
        ...
        const data = upper === "TRUE" ? true : upper === "FALSE" ? false : upper === "INDETERMINATE" ? BooleanIndeterminate : BooleanEmpty;
        return {
          ...existing,
          data
        };
...
export { coercePasteCell, pasteBufferToString };
//# sourceMappingURL=paste-coercion.js.map
