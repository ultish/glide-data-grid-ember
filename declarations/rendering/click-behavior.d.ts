 ...
 */
export declare function isValidClick(down: Item | undefined, up: Item, isTouch?: boolean): boolean;
 ...
 */
export declare function shouldActivateOnClick(args: ClickActivationArgs): boolean;
/**
 ...
 */
export declare function resolvePointerActivation(behavior: CellActivationBehavior, isDoubleClick: boolean): CellActivationBehavior;
//# sourceMappingURL=click-behavior.d.ts.map