...
export function dragKindForHit(kind: "cell" | "header" | "out-of-bounds", row: number): DragHitKind {
 ...
 */
export function canDragFrom(isDraggable: IsDraggable | undefined, kind: DragHitKind): boolean {
 ...
 */
export function isDraggableAttr(isDraggable: IsDraggable | undefined): boolean {
 ...
 */
export function hasDropTargetChanged(
