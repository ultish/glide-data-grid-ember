 ...
 */
export function computeScrollDelta(viewport: ScrollToViewport, params: ScrollToParams = {}): { x: number; y: number } {
    const { target, width, height, frozenWidth, headerHeight } = viewport;
